{{-- Header --}}
<header class="fixed top-0 w-full z-50 bg-surface-container-lowest shadow-sm border-b border-outline-variant rounded-b-2xl md:rounded-none flex items-center justify-between px-3 md:px-8 h-16">

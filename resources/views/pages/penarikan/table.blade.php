            ...
            <x-slot:mobile>
                ...
                <div class="p-3 space-y-3" id="mBody">
                    ...
                    <div class="border border-outline-variant rounded-xl p-4 bg-surface-container-lowest shadow-sm" data-id="{{ $table->field_primary }}">
                        <p class="text-sm font-bold text-on-surface truncate mb-3">Rp{{ number_format((int) $table->penarikan_nominal, 0, ',', '.') }}</p>
                        <div class="grid grid-cols-2 gap-3 mb-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs font-medium text-on-surface">{{ $table->created_at?->format('d/m/Y H:i') }}</p>
                            </div>
                        </div>

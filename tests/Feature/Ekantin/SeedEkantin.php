...
trait SeedEkantin
{
    ...
    {
        $pengguna = User::create(['name' => 'Pengguna Tes', 'email' => 'pengguna@sekolah.id', 'password' => 'secret123', 'role' => 'pengguna']);
        $vendor = User::create(['name' => 'Vendor Tes', 'email' => 'vendor@sekolah.id', 'password' => 'secret123', 'role' => 'vendor']);
        $kartu = Kartu::create(['kartu_barcode' => 'SW-TEST-001', 'kartu_id_user' => $pengguna->id, 'kartu_nis' => 'NIS001', 'kartu_kelas' => '7A', 'kartu_saldo' => $saldo, 'kartu_status' => 'aktif']);
